...
class Student(db.Model):
    ...
    password = db.Column(db.String(255), nullable=False, default='demo123')
    ...
    try:
        ...
        return jsonify({
            ...
            'dashboard': {
                ...
                'quick_actions': [
                    {'action': 'Start Mock Test', 'icon': '📝', 'route': '/test'},
                    {'action': 'Analyze Paper', 'icon': '📄', 'route': '/paper-analysis'},
                    {'action': 'View Analytics', 'icon': '📊', 'route': '/analytics'},
                    {'action': 'Daily Quiz', 'icon': '❓', 'route': '/quiz'},
                    {'action': 'Study Plan', 'icon': '🎯', 'route': '/study-plan'},
                    {'action': 'Resources', 'icon': '📚', 'route': '/resources'}
                ]
            }
        })
